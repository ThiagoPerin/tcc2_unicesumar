<script>
    ...
    import CarbonatcaoForm from '../components/Forms/CarbonatcaoForm.svelte';
    import CarbonatacaoTableRow from '../components/Tables/CarbonatacaoTableRow.svelte';
	...
	let registros = [];
	onMount(async () => {
		registros = await CarbonatacaoFetches.fetchCarbonatacaoData(odp);
		loader = false;
	});
					...
					<table class="table table-hover table-striped">
						<thead>
							<tr>
								...
								<th scope="col">Temp. Início</th>
								<th scope="col">Temp. Fim</th>
						...
						<tbody id="corpoTabela">
									{#each registros as registro}
										<CarbonatacaoTableRow registro={registro} on:message={hanldeRowAction}/>
									{/each}
								</tbody>
							</table>
						</div>
