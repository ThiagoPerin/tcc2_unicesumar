<script>
    ...
    import MedicaoPhForm from '../components/Forms/MedicaoPhForm.svelte';
    import MedicaoPhTableRow from '../components/Tables/MedicaoPhTableRow.svelte';
	...
	let registros = [];
	onMount(async () => {
		registros = await MedicaoPhFetches.fetchMedicaoPhData(odp);
		loader = false;
	});
					...
					<table class="table table-hover table-striped">
						...
						<tbody id="corpoTabela">
							{#each registros as registro}
								<MedicaoPhTableRow registro={registro} on:message={hanldeRowAction}/>
							{/each}
						</tbody>
					</table>
				</div>
