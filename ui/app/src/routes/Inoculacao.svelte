<script>
    ...
    import InoculacaoForm from "../components/Forms/InoculacaoForm.svelte";
    ...
    import InoculacaoTableRow from '../components/Tables/InoculacaoTableRow.svelte';
	...
	const pageTitle = "INOCULAÇÃO DE LEVEDURA";
	...
	let registros = [];
	onMount(async () => {
		registros = await InoculacaoFetches.fetchInoculacaoData(odp);
		loader = false;
	});
					...
					<table class="table table-hover table-striped">
						<thead>
							<tr>
								...
								<th scope="col">Levedura</th>
								<th scope="col">Origem/Lote</th>
						...
						<tbody id="corpoTabela">
									{#each registros as registro}
										<InoculacaoTableRow registro={registro} on:message={hanldeRowAction}/>
									{/each}
								</tbody>
							</table>
						</div>
