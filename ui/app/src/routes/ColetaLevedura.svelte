<script>
    ...
    import ColetaLeveduraForm from '../components/Forms/ColetaLeveduraForm.svelte';
    import ColetaLeveduraTableRow from '../components/Tables/ColetaLeveduraTableRow.svelte';
	...
	const pageTitle = "COLETA DE LEVEDURA";
	...
	let registros = [];
	onMount(async () => {
		registros = await ColetaLeveduraFetches.fetchColetaLeveduraData(odp);
		loader = false;
	});
					...
					<table class="table table-hover table-striped">
						...
						<tbody id="corpoTabela">
							{#each registros as registro}
								<ColetaLeveduraTableRow  registro={registro} on:message={hanldeRowAction}/>
							{/each}
						</tbody>
					</table>
						</div>
