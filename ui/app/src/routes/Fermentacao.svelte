<script>
    ...
    import FermentacaoForm from "../components/Forms/FermentacaoForm.svelte";
    ...
    import FermentacaoTableRow from "../components/Tables/FermentacaoTableRow.svelte";
	...
	const pageTitle = "FERMENTAÇÃO FORÇADA";
	...
	let registros = [];
	onMount(async () => {
		registros = await FermentacaoForcadaFetches.fetchFermentacaoForcadaData(odp);
		loader = false;
	});
					...
					<table class="table table-hover table-striped">
						<thead>
							<tr>
								...
								<th scope="col">Extrato inicial</th>
								<th scope="col">Extrato final</th>
								<th scope="col">Dias teste</th>
								<th scope="col">Horas agit</th>
						...
						<tbody id="corpoTabela">
							{#each registros as registro}
								<FermentacaoTableRow registro={registro} on:message={hanldeRowAction}/>
							{/each}
						</tbody>
					</table>
				</div>
