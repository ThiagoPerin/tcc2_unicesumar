<script>
    ...
    import TransferenciaForm from '../components/Forms/TransferenciaForm.svelte';
    import TransferenciaTableRow from '../components/Tables/TransferenciaTableRow.svelte';
	...
	const pageTitle = "TRANSFERÊNCIAS (PURGAS E DESCARTES)";
	...
	let registros = [];
	onMount(async () => {
		registros = await TransferenciaFetches.fetchTransferenciaData(odp);
		loader = false;
	});
					...
					<table class="table table-hover table-striped">
						...
						<tbody id="corpoTabela">
									{#each registros as registro}
										<TransferenciaTableRow registro={registro} on:message={hanldeRowAction}/>
									{/each}
								</tbody>
							</table>
						</div>
